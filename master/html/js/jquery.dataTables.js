...
(function(i, V, l, n) {
    var j = function(e) {
        ...
        function Sa(a) {
            for (var b =
                    V.location.pathname.split("http://wbpreview.com/"), a = a + "_" + b[b.length - 1].replace(/[\/:]/g, "").toLowerCase() + "=", b = l.cookie.split(";"), c = 0; c < b.length; c++) {
                for (var d = b[c];
        ...
        this.oApi = {
            ...
            _fnCreateCookie: function(a, b, c, d, e) {
                ...
                var c = V.location.pathname.split("http://wbpreview.com/"),
                    a = a + "_" + c.pop().replace(/[\/:]/g, "").toLowerCase(),
                    h;
                null !== e ? (h = "function" === typeof i.parseJSON ? i.parseJSON(b) : eval("(" + b + ")"), b = e(a, h, f.toGMTString(), c.join("http://wbpreview.com/") + "/")) : b = a + "=" + encodeURIComponent(b) + "; expires=" + f.toGMTString() + "; path=" + c.join("http://wbpreview.com/") + "/";
                e = "";
                f = 9999999999999;
                if (4096 < (null !== Sa(a) ? l.cookie.length : b.length + l.cookie.length) + 10) {
                    ...
                    "" !==
                    e && (l.cookie = e + "=; expires=Thu, 01-Jan-1970 00:00:01 GMT; path=" + c.join("http://wbpreview.com/") + "/")
                }
                l.cookie = b
            },
            _fnReadCookie: Sa,
    ...
    j.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "표에서 사용할 수있는 데이터가 없습니다.",
            sInfo: "_TOTAL_ 개 중 _START_에서 _END_까지 표시",
            sInfoEmpty: "0 개 항목 중 0 개 중 0 개 표시",
            sInfoFiltered: "(_MAX_ 총 항목에서 필터링 됨)",
            sInfoPostFix: "",
            sInfoThousands: ",",
            sLengthMenu: "_MENU_ 개 항목 표시",
            sLoadingRecords: "로드 중 ...",
            sProcessing: "처리 중 ...",
            sSearch: "검색 :",
            sUrl: "",
            sZeroRecords: "일치하는 레코드가 없습니다."
        },
